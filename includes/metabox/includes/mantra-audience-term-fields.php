<?php
if( ! class_exists( 'Mantra_Audience_Term_Meta' ) ) :
/**
...
class Mantra_Audience_Term_Meta {
	...
	public function get_fields( $taxonomy ) {
		if ( empty( $this->fields[ $taxonomy ] ) ) {
			$this->fields[ $taxonomy ] = apply_filters( "mantra_audience_metabox/taxonomy/{$taxonomy}/fields", array() );
		}
...
Mantra_Audience_Term_Meta::get_instance();